...
ALTER TABLE ONLY public.comet DROP CONSTRAINT comet_pkey;
ALTER TABLE ONLY public.comet DROP CONSTRAINT comet_name_key;
...
ALTER TABLE public.comet ALTER COLUMN comet_id DROP DEFAULT;
...
DROP SEQUENCE public.comet_comet_id_seq;
DROP TABLE public.comet;
